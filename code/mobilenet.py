...
batch_size = 128
num_epochs=100
models_path = "../models/mobilenet_Best_model.pth"
data_dir = "../data/image_files"
file_name = "../metrics/Training_stats_csvs/mobilenet_Training_metric.csv"
report_file = '../metrics/performance_metrics/mobilenet_report.md'
confusion_file = '../metrics/confusion_matrix/mobilenet_confusion.png'
