...
batch_size = 128
num_epochs=100
models_path = "../models/Resnet_Best_model.pth"
data_dir = "../data/image_files"
file_name = "../metrics/Training_stats_csvs/Resnet_Training_metric.csv"
report_file = '../metrics/performance_metrics/resnet_report.md'
confusion_file = '../metrics/confusion_matrix/resnet_confusion.png'
